...
public class AuditController : ControllerBase
{
        ...
        [FromQuery] int? statusCode = null)
    {
        ...
        // Parse headers safely in memory (after EF query)
        var result = items.Select(x => new
        {
            routing = new
            {
                ...
                x.routing.DecidedAt,
                headers = TryParseJson(x.routing.ModelVersion), // will be null if invalid
                bodyPreview = x.routing.ModelVersion // adjust if you store response body
            },
            request = x.request == null ? null : new
            {
                ...
                body = x.request.ContentType // placeholder – add real field if needed
            }
        });
